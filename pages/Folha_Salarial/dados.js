...
function Dados(props){
    ...
    let producaoFilterUser = filterpro.filter( item => item.costureiro == props.nome)

    let objetosFiltradosAnoMes = producaoFilterUser.filter( item => item.data_costura.substr(3) == props.mess+'/'+ano)
