...
function FimP(props) {
  ...
  function TerminoCostura(id) {
    ...
    const fim = firestore()
      ...
      .doc(id)
      .update({
        status: props.plataforma != '#FFFF' ? 6 : 5,
      ...
      <Modal
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => TerminoCostura(props.id)}>
            <View
              style={{
      ...
      <View
        ...
        <View
          ...
          <View
            ...
            <Text style={{color: '#ffff', fontSize: 10, marginTop: 3}}>
              <Icon name="time" size={10} color={'#ffff'} /> Em Produção por{' '}
              {props.costureiro}
            </Text>
          </View>
        </View>
        <View
          ...
          {costureiroUid == props.costureiro ? (
            <TouchableOpacity
              style={{
                alignItems: 'center',
                padding: 5,
              ...
              onPress={() => setModalVisible(!modalVisible)}>
              <Text
                style={{fontWeight: 'bold', color: '#FF7751', fontSize: 13}}>
                Finalizar {props.modelo}
              </Text>
            </TouchableOpacity>
          ) : (
            <></>
