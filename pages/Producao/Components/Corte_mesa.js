...
import { Text, View, Alert, Image, TouchableOpacity ,Modal, TextInput, StyleSheet, Button} from "react-native";
...
function Cortar_Mesa(props) {
      ...
      if(quant == quantidade){
        ...
        .then(() => {
          const subscriber = firestore()
            ...
            .then(() => Alert.alert("Produção", "Produção adcionada!"), setQuantidade(props.quantidade))
  ...
  return (
    <>
    <View style={{padding: 3, borderRadius: 6, backgroundColor:'white', marginTop: 3}}>
    ...
    <Modal
      ...
      >
        <View style={{ backgroundColor: "#027381", flex: 1,flexDirection: 'column', justifyContent: 'center', alignItems: 'center'  }}>
          ...
          />
           ...
           <TouchableOpacity style={{width: '90%',marginTop: 10}}  onPress={() =>  MandarPC(props.id, props.quantidade)}>
            <View style={{backgroundColor: "#FF7751", height: 40, flexDirection: 'row',borderRadius: 10, justifyContent: 'center', alignItems: 'center'}}>
           
            <Text style={{fontSize:15, fontWeight: 'bold', color: '#fff'}}>Mandar Para Costura</Text>
            </View>
          </TouchableOpacity>
      ...
      <View style={{width: '75%', flexDirection: 'column', justifyContent: 'center',}}>
        ...
        <Text style={{fontSize: 10, fontWeight: 'bold', color: '#696969'}}>{props.modelo}</Text>
       </View>
    ...
    <View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: 5}}>
      <TouchableOpacity style={{ alignItems: 'center', flexDirection: 'column', justifyContent: 'center', padding: 5, width: '90%', backgroundColor: '#FF7751', borderRadius: 5, elevation: 5}} onPress={() => setModalVisible(!modalVisible)}>
       <Text style={{fontWeight: 'bold', color: '#ffff', fontSize: 16}}>Mandar para Costura</Text>
      </TouchableOpacity>
